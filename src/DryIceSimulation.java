 ...
 * are managed by {@link DryIceApplication}. If there are devices found (throughout
...
public class DryIceSimulation {
	public static void main(final String[] args) throws IOException,
		...
		final TinkerforgeApplication application = new DryIceApplication();
